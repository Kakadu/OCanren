    ...
    include struct
      ...
      let (reify : (_, logic t OCanren.logic) Reifier.t) =
        ...
        Reifier.fix (fun self ->
            OCanren.reify <..> chain (zed (Reifier.rework ~fv:(fmapt self))))
      ;;
  ...
  module _ = struct
    include struct
      ...
      let reify ra =
        ...
        let open Env.Monad.Syntax in
        Reifier.fix (fun self ->
            OCanren.reify <..> chain (zed (Reifier.rework ~fv:(fmapt ra))))
      ;;
  ...
  module _ = struct
    include struct
      ...
      let reify ra =
        ...
        let open Env.Monad.Syntax in
        Reifier.fix (fun self ->
            OCanren.reify <..> chain (zed (Reifier.rework ~fv:(fmapt ra self))))
      ;;
    ...
    let run_list n =
      run_new [%reify: GT.int t] (GT.show logic (GT.show OCanren.logic (GT.show GT.int))) n
    ;;
  ...
  module Moves = struct
    include struct
      ...
      let (reify : (_, GT.int OCanren.logic t OCanren.logic) Reifier.t) =
        ...
        let open Env.Monad.Syntax in
        Reifier.fix (fun self ->
            OCanren.reify <..> chain (zed (Reifier.rework ~fv:(fmapt OCanren.reify))))
      ;;
