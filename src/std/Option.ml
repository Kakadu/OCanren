...
type 'a logic'        = 'a logic                        [@@deriving gt ~plugins:{ show; gmap; html; eq; compare; foldl; foldr; fmt }]

let logic' = logic;;

type 'a ground        = 'a GT.option                    [@@deriving gt ~plugins:{ show; gmap; html; eq; compare; foldl; foldr; fmt }]
type 'a logic         = 'a GT.option logic'             [@@deriving gt ~plugins:{ show; gmap; html; eq; compare; foldl; foldr; fmt }]
...
type 'a t = 'a ground  [@@deriving gt ~plugins:{ show; gmap; html; eq; compare; foldl; foldr; fmt }];;
let t = ground
