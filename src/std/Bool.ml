...
type ground    = GT.bool                  [@@deriving gt ~options:{show; gmap; eq; compare; foldl; foldr; fmt}]
type t         = GT.bool                  [@@deriving gt ~options:{show; gmap; eq; compare; foldl; foldr; fmt}]
type logic     = GT.bool logic'           [@@deriving gt ~options:{show; gmap; eq; compare; foldl; foldr; fmt}]
