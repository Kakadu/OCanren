...
module Fmap2 (T : T2) : sig
  ...
  val reify
    :  (Env.t -> ('a, 'b) injected -> 'b)
    -> (Env.t -> ('c, 'd) injected -> 'd)
    -> Env.t
    -> (('a, 'c) T.t, (('b, 'd) T.t logic as 'r)) injected
    -> 'r
...
module Fmap3 (T : T3) : sig
  ...
  val reify
    :  (Env.t -> ('a, 'b) injected -> 'b)
    -> (Env.t -> ('c, 'd) injected -> 'd)
    -> (Env.t -> ('e, 'f) injected -> 'f)
    -> Env.t
    -> (('a, 'c, 'e) T.t, (('b, 'd, 'f) T.t logic as 'r)) injected
    -> 'r
  ...
  val prjc
    ...
    -> (int -> 'r list -> 'r)
    -> Env.t
    -> ((('a, 'c, 'e) T.t as 'r), ('b, 'd, 'f) T.t logic) injected
    -> 'r
end

module Fmap4 (T : T4) : sig
  val distrib
  ...
  val reify
    ...
    -> (Env.t -> ('c, 'd) injected -> 'd)
    -> (Env.t -> ('e, 'f) injected -> 'f)
    -> (Env.t -> ('g, 'h) injected -> 'h)
    -> Env.t
    -> (('a, 'c, 'e, 'g) T.t, (('b, 'd, 'f, 'h) T.t logic as 'r)) injected
    -> 'r
  ...
  val prjc
    ...
    -> (Env.t -> ('c, 'd) injected -> 'c)
    -> (Env.t -> ('e, 'f) injected -> 'e)
    -> (Env.t -> ('g, 'h) injected -> 'g)
    -> (int -> 'r list -> 'r)
    -> Env.t
    -> ('r, ('b, 'd, 'f, 'h) T.t logic) injected
    -> (('a, 'c, 'e, 'g) T.t as 'r)
end

module Fmap5 (T : T5) : sig
  val distrib
    :  ( ('a, 'b) injected
       , ('c, 'd) injected
       , ('e, 'f) injected
  ...
  val reify
    ...
    -> (Env.t -> ('e, 'f) injected -> 'f)
    -> (Env.t -> ('g, 'h) injected -> 'h)
    -> (Env.t -> ('i, 'j) injected -> 'j)
    -> Env.t
    -> (('a, 'c, 'e, 'g, 'i) T.t, (('b, 'd, 'f, 'h, 'j) T.t logic as 'r)) injected
    -> 'r
  ...
  val prjc
    ...
    -> (int -> 'r list -> 'r)
    -> Env.t
    -> ('r, ('b, 'd, 'f, 'h, 'j) T.t logic) injected
    -> (('a, 'c, 'e, 'g, 'i) T.t as 'r)
end

module Fmap6 (T : T6) : sig
  val distrib
    :  ( ('a, 'b) injected
       , ('c, 'd) injected
       , ('e, 'f) injected
  ...
  val reify
    ...
    -> (Env.t -> ('g, 'h) injected -> 'h)
    -> (Env.t -> ('i, 'j) injected -> 'j)
    -> (Env.t -> ('k, 'l) injected -> 'l)
    -> Env.t
    -> (('a, 'c, 'e, 'g, 'i, 'k) T.t, (('b, 'd, 'f, 'h, 'j, 'l) T.t logic as 'r)) injected
    -> 'r
  ...
  val prjc
    ...
    -> (Env.t -> ('g, 'h) injected -> 'g)
    -> (Env.t -> ('i, 'j) injected -> 'i)
    -> (Env.t -> ('k, 'l) injected -> 'k)
    -> (int -> 'r list -> 'r)
    -> Env.t
    -> ('r, ('b, 'd, 'f, 'h, 'j, 'l) T.t logic) injected
