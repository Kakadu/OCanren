...
(** Call [structural var reifier checker] adds a structural constraint for future use.
 ...
 See also: {!debug_var}.
*)
val structural : 'a -> ('a, 'b) Reifier.t -> ('b -> bool) -> goal
...
(* module Tabling : sig
  val succ
    :  (unit -> (('a -> 'b) -> 'c) * ('d -> 'e -> 'f))
    -> unit
    -> (('g ilogic * 'a -> 'b) -> 'g ilogic -> 'c) * (('i -> 'd) -> 'i * 'e -> 'f)

  val one : unit -> (('a ilogic -> 'c) -> 'a ilogic -> 'c) * (('d -> 'e) -> 'd -> 'e)

  val two
    :  unit
    -> (('a ilogic * 'c ilogic -> 'e) -> 'a ilogic -> 'c ilogic -> 'e)
       * (('f -> 'g -> 'h) -> 'f * 'g -> 'h)
  ...
  val four
    :  unit
    -> (('a ilogic * ('c ilogic * ('e ilogic * 'g ilogic)) -> 'i)
        -> 'a ilogic
        -> 'c ilogic
        -> 'e ilogic
        -> 'g ilogic
  ...
  val five
    :  unit
    -> (('a ilogic * ('c ilogic * ('e ilogic * ('g ilogic * 'i ilogic))) -> 'k)
        -> 'a ilogic
        -> 'c ilogic
        -> 'e ilogic
        -> 'g ilogic
