...
module Fresh : sig
  ...
  val five
    :  (_ injected -> _ injected -> _ injected -> _ injected -> _ injected -> goal)
    -> goal
...
val one
  :  unit
  -> ((('a, 'b) injected -> goal) -> State.t -> ('a, 'b) injected * State.t Stream.t)
     * (('c, 'd) injected -> Env.t -> ('c, 'd) reified)
     * ('e -> 'e)
     * (('f -> 'g) -> 'f -> 'g)
...
val three
  ...
  -> ((('a, 'b) injected -> ('c, 'd) injected -> ('e, 'f) injected -> goal)
      -> State.t
      -> ('a, 'b) injected * (('c, 'd) injected * (('e, 'f) injected * State.t Stream.t)))
...
val four
  ...
  -> ((('a, 'b) injected
      ...
      -> ('a, 'b) injected
         * (('c, 'd) injected
           * (('e, 'f) injected * (('g, 'h) injected * State.t Stream.t))))
     * (('i, 'j) injected * (('k, 'l) injected * (('m, 'n) injected * ('o, 'p) injected))
        -> Env.t
        -> ('i, 'j) reified * (('k, 'l) reified * (('m, 'n) reified * ('o, 'p) reified)))
     * ('q * ('r * ('s * ('t * 'u))) -> ('q * ('r * ('s * 't))) * 'u)
     * (('v -> 'w -> 'x -> 'y -> 'z) -> 'v * ('w * ('x * 'y)) -> 'z)
...
val five
  ...
  -> ((('a, 'b) injected
      ...
      -> ('a, 'b) injected
         * (('c, 'd) injected
           * (('e, 'f) injected
             * (('g, 'h) injected * (('i, 'j) injected * State.t Stream.t)))))
     * (('k, 'l) injected
        * (('m, 'n) injected
