  $ ./test013.exe
  fun q -> Bool.noto' Bool.true_ q, 1 answer {
  q=false;
  }
  fun q -> Bool.noto' Bool.false_ q, 1 answer {
  q=true;
  }
  fun q -> Bool.noto' q Bool.true_, 1 answer {
  q=false;
  }
  fun q -> Bool.oro Bool.false_ Bool.false_ q, 1 answer {
  q=false;
  }
  fun q -> Bool.oro Bool.false_ Bool.true_ q, 1 answer {
  q=true;
  }
  fun q -> Bool.oro Bool.true_ Bool.false_ q, 1 answer {
  q=true;
  }
  fun q -> Bool.oro Bool.true_ Bool.true_ q, 1 answer {
  q=true;
  }
  fun q -> Bool.ando Bool.false_ Bool.false_ q, 1 answer {
  q=false;
  }
  fun q -> Bool.ando Bool.false_ Bool.true_ q, 1 answer {
  q=false;
  }
  fun q -> Bool.ando Bool.true_ Bool.false_ q, 1 answer {
  q=false;
  }
  fun q -> Bool.ando Bool.true_ Bool.true_ q, 1 answer {
  q=true;
  }
  ...
  fun q -> List.allo (Bool.true_ % (q %< Bool.true_)) Bool.true_, 1 answer {
  q=true;
  }
  fun q r s -> List.allo (Bool.true_ % (q %< r)) s, all answers {
