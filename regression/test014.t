  ...
  q=[0; 0; 1]; r=[0; 0; 0; 1];
  q=[0; 1; 1]; r=[0; 0; 1; 1];
  q=[1; _.164; _.408; 1]; r=[0; 1; _.164; _.408; 1];
  ...
  q=[_.23; _.29; 1]; r=[_.25; _.31; _.60; _.61 | _.62];
  q=[_.17; _.21; _.37; _.56; 1]; r=[_.19; _.27; _.42; _.58; 1];
  q=[_.23; _.29; _.48; 1]; r=[_.25; _.31; _.54; _.79; _.80 | _.81];
  q=[_.17; _.21; _.37; _.56; _.73; 1]; r=[_.19; _.27; _.42; _.58; _.77; 1];
  q=[_.23; _.29; _.48; _.71; 1]; r=[_.25; _.31; _.54; _.75; _.98; _.99 | _.100];
  q=[_.17; _.21; _.37; _.56; _.73; _.90; 1]; r=[_.19; _.27; _.42; _.58; _.77; _.94; 1];
  q=[_.23; _.29; _.48; _.71; _.92; 1]; r=[_.25; _.31; _.54; _.75; _.96; _.121; _.122 | _.123];
  }
  fun q -> lto (build_num 5) q, all answers {
  q=[_.13; _.23; _.43; _.44 | _.45];
  q=[0; 1; 1];
  q=[1; 1; 1];
  }
  ...
  q=[_.32; _.46; 1]; r=[_.34; _.50; _.117; _.118 | _.119]; s=[]; t=[_.32; _.46; 1];
  q=[_.32; _.46; _.88; 1]; r=[_.34; _.50; _.98; _.174; _.175 | _.176]; s=[]; t=[_.32; _.46; _.88; 1];
  q=[_.32; _.46; _.88; _.151; 1]; r=[_.34; _.50; _.98; _.157; _.216; _.217 | _.218]; s=[]; t=[_.32; _.46; _.88; _.151; 1];
  }
